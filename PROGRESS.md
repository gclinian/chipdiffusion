...
- [ ] 12.7 結案前實驗 Phase 5（使用者核准 09-25）— **In progress**：5A 超參數篩選 11 組（seed 300）→ 5B bigblue2 開 guidance →
  5A stage 2（通過者補 seeds）。`scripts/run_phase5_AB.sh`，預登記見 plan Phase 5。
